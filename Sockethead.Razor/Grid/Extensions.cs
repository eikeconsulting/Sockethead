...
namespace Sockethead.Razor.Grid
{
    ...
    {
        public static SimpleGrid<T> SimpleGrid<T>(this IHtmlHelper html, IQueryable<T> source, string gridId = null) where T : class
                => new SimpleGrid<T>(html, source, gridId);

        public static SimpleGrid<T> SimpleGrid<T>(this IHtmlHelper html, IEnumerable<T> source, string gridId = null) where T : class
                => new SimpleGrid<T>(html, source.AsQueryable(), gridId);
