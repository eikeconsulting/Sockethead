...
namespace Sockethead.Web.Areas.Samples.Utilities
{
    public static class SimpleFormFeatures
    {
        public static List<Feature> Features { get; } = new()
        {
            ...
            new()
            {
                Url = "SelectionControls",
                Name = "Selection Controls",
                Description = "Demonstrates support for Enum, Radio Button, Dropdown, and Listbox.",
            },
            new()
            {
                Url = "HorizontalForm",
            ...
            {
                Url = "MixedLayoutForm",
                Name = "Mixed Layout Form",
                Description = "Mix vertical and horizontal layout in a single form.",
            },
            new()
            {
                Url = "RegisterEnums",
                Name = "Register Enums",
                Description = "Enable enums to be automatically generated by registering them.",
            },
            new()
            {
                Url = "CustomizeLayout1",
                Name = "Customize Layout",
                Description = "Customized the layout with rows and columns in your form.",
            },
            new()
            {
                Url = "CustomizeLayout2",
                Name = "Two Column Layout",
                Description = "Lay the form out in two columns.",
            },
            new()
            {
                Url = "Prompt",
            ...
            */
            ...
            new()
            {
                Name = "DateTime and Date",
                Description = "This demonstrates how to use the DateTime and Date input types.",
            },
            new()
            {
                Name = "Number Inputs",
